Feature: 2. Scheduling - Asset Pickup
    ...
    @lane-regression
    Scenario: Verify Confirm Appointment Button
        ...
        Then I verify 'appointmentScreenHdr' should be visible on Schedule Pickup Delivery Queue
        And I verify 'pickupAppointmentHdr' should be visible for Schedule Asset Pickup
    ...
    @lane-regression
    Scenario: Verify order moved to Appointment Queue
        When I click on 'workQueueScreenBtn' for Schedule and Pickup Delivery Queue
        Then I verify 'cardOnDeliveryQueue' should be visible on Schedule Pickup Delivery Queue
        When I double click on 'cardOnDeliveryQueue' on Schedule Pickup Delivery Queue
        Then I verify 'schedulePickupHdr' should be visible for Contracting Documents and Payment Indicator
        ...
        And I verify 'pickupAppointmentHdr' should be visible for Schedule Asset Pickup
        When I click on 'workQueueScreenBtn' for Schedule and Pickup Delivery Queue
        Then I verify 'vehicleCardInAppointmentsQueue' should be visible on Schedule Pickup Delivery Queue
        When I click on 'appointmentsSearchButton' for Schedule Asset Pickup
        ...
        Then I verify 'orderIdOnAppointmentCard' should have 'orderID' for Schedule Asset Pickup
        When I double click on 'vehicleCardInAppointmentsQueue' fo Schedule Asset Pickup
