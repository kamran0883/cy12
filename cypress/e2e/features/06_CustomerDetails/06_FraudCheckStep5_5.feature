Feature: Order Creation in Dealer Portal - Fraud Check Step 5.4
    ...
    #--------------------TC-24518--------------------#
    @lane-regression
    Scenario: Verify Application can be submitted for credit approval
    ...
    #--------------------TC-32640--------------------#
    @lane-regression
    Scenario: Verify that Submit Credit Application Button is enabled if fraud check has passed
        When I click on 'submitOrderBtn' on Personal Finance Screen
        Then I verify fraud check is 'passed' based on Fraud Check API response
    ...
    #--------------------TC-24660--------------------#
    @lane-regression
    Scenario: Verify the assset status in inventory when fraud check has passed
        When I click on 'submitOrderBtn' on Personal Finance Screen
        Then I verify fraud check is 'passed' based on Fraud Check API response
        When I save 'orderID' as 'orderID' in data file
